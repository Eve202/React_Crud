...
const Card = ({ student , openModal }) => {
    return (
        <React.Fragment>
            <div className={`w-40 h-48 border-t-2 ${ student['status'] === 'Nouveau' ? 'border-blue-500' : student['status'] === 'Transfert' ? 'border-cyan-500' : 'border-red-500' } bg-white shadow-md rounded-es-lg rounded-ee-lg flex flex-col justify-between`}>
